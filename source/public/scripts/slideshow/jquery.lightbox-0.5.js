...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'scripts/slideshow/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'scripts/slideshow/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'scripts/slideshow/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'scripts/slideshow/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'scripts/slideshow/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
