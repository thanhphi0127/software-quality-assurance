...
$lang['isset']				= "%s phải có một giá trị.";
$lang['valid_email']		= "%s phải chứa một địa chỉ email hợp lệ.";
$lang['valid_emails']		= "%s phải chứa tất cả địa chỉ email hợp lệ.";
$lang['valid_url']			= "%s field must contain a valid URL.";
$lang['valid_ip']			= "%s field must contain a valid IP.";
$lang['min_length']			= "%s phải chứa ít nhất %s kí tự.";
$lang['max_length']			= "%s không thể vượt quá %s kí tự.";
$lang['exact_length']		= "%s phải chứa ".CIT_PASS_LENGTH." kí tự.";
...
$lang['regex_match']		= "%s không đúng định dạng.";
