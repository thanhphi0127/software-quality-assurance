    ...
    <div class="container khung">
        <div class="login-header">
            <div class="col-md-8">
                <img style="margin: 0 0 0 0; padding-top: 3px;" src="public/img/nhatro/home-icon.png"/>
                <font style="color: white; font-size: 25px; font-weight: bold;">Thông tin nhà trọ</font>
            </div>
            <div class="col-md-4">
                <div class="name-home">
                    <a style="float: right; margin-left: 25px;" href="<?php echo CIT_BASE_URL();?>index.php/home/logout" class="btn btn-success square-btn-adjust">Đăng nhập</a> &nbsp;&nbsp;&nbsp;
                    <a style="float: right; width: 90px;" href="<?php echo CIT_BASE_URL();?>index.php/home/logout" class="btn btn-success square-btn-adjust">Đăng ký</a>
                </div>
            </div>
        </div>
