      ...
      <div class="modal-content">
          ...
          <table id="table_add" border="0">
                  ...
                  <tr>
                  	...
                  	<td>
                          <input name="add[ngaysinh]" type="text" class="form-control" value="<?php echo set_value('ngaysinh'); ?>" placeholder="yyyy/mm/dd" />
                ...
                <tr><td> <label>Mail (*)</label></td><td><input name="add[mail]" type="text" class="form-control" placeholder="Nhập địa chỉ mail" value="<?php echo set_value('mail'); ?>"/>
                  ...
                  <tr><td><label>Ngày đăng kí(*)</label></td>
                  	  <td>
                      	<input type="text"  name="add[ngaydangki]"value="<?php echo date('Y-m-d G:m:s'); ?>" class="form-control" readonly="readonly" />
                      </td>
                  </tr>
