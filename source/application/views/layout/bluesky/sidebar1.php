			  ...
			  <!--
                ...
                <p style="text-align: left;">
                  ...
                  <select id="updates" name="updates">
                    ...
                    <option value="1" selected>Tr?n Van KhÈo</option>
                  </select>
                </p>
				...
				<div>
                  <form action="<?php echo CIT_BASE_URL.'search/quicksearch';?>" class="art-search standardform" method="post" name="searchform">
                    <input type="text" style='padding: 3px 10px;padding-right: 29px !important;text-transform: none;' value="" name="keyword" placeholder='B·∫°n mu·ªën t√¨m g√¨ ?' />
